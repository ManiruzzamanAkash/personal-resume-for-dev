...
export const CONTENT: Content = {
  site: {
    ...
    tagline: 'Senior Software Engineer · Senior WordPress Plugin Developer · Software Architect — 7+ years building scalable plugins, eCommerce systems, and developer tools used by 100K+ users worldwide.',
  ...
  seo: {
    ...
    routes: {
      home: {
        path: '/',
        title: '{fullName} — Senior WordPress Plugin Developer & Software Architect',
        description: "I'm {fullName} — a Senior Software Engineer & Senior WordPress Plugin Developer with 7+ years engineering scalable plugins, eCommerce platforms (SureCart, Dokan, WP ERP), and developer tools used by 100K+ users worldwide. Based in {location}.",
        keywords: [
          'Senior WordPress Plugin Developer',
          'Senior Software Engineer',
          'Software Architect',
      ...
      resume: {
        path: '/resume',
        title: 'Resume · {fullName} — Senior Software Engineer & WordPress Architect',
        description: 'Seven years of shipping software across WordPress, Laravel, React, and Symfony. Detailed CV of {fullName} — Senior WordPress Plugin Developer at Brainstorm Force, ex-Paysera, ex-weDevs. Open to senior engineering and architecture roles.',
        keywords: [
      ...
      contact: {
        path: '/contact',
        title: 'Contact · {fullName} — Hire a Senior WordPress Plugin Developer',
        description: "Get in touch with {fullName} — Senior Software Engineer & WordPress Architect. Open to senior plugin development, architecture review, and consulting engagements. Based in {location}, available worldwide remote.",
        keywords: [
          'Hire Senior WordPress Developer',
          'WordPress Plugin Consultant',
    ...
    faq: [
      {
        ...
        a: 'Maniruzzaman Akash is a Senior WordPress Plugin Developer and Software Architect from Dhaka, Bangladesh, with 7+ years of experience building scalable WordPress plugins, eCommerce systems, and developer tools used by 100K+ users worldwide.',
      },
      {
        q: 'What does Maniruzzaman Akash do?',
        a: 'He works as a Senior WordPress Plugin Developer at Brainstorm Force engineering SureCart, and contributes to open-source projects including Dokan Multivendor, WP ERP, and Lara Dashboard.',
      },
      {
        q: 'What technologies does Maniruzzaman Akash use?',
        a: 'PHP, WordPress, Gutenberg, WooCommerce, Laravel, Symfony, React, TypeScript, Node.js, MySQL, Redis, Docker, and modern AI tooling including Claude, OpenAI, and MCP.',
      },
      {
        q: 'Is Maniruzzaman Akash available for hire?',
        a: 'He is open to senior engineering roles, plugin development engagements, and architecture consulting. The fastest way to reach him is by email at manirujjamanakash@gmail.com or via Calendly.',
      },
    ],
  },
