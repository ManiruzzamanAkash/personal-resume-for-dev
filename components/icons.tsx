/* ============================================================
   ...
   Use as <I.rocket /> or <Icon name="rocket" />.
   Lightweight, tree-shakeable, no runtime fetch.
   ============================================================ */
...
const fill = (props: IconProps): IconProps => ({
  fill: 'currentColor',
  'aria-hidden': true,
  ...props,
});
...
const GithubIcon = (props: IconProps) => (
  <svg viewBox="0 0 24 24" {...fill(props)}>
...
export const I: Record<IconName, ComponentType<IconProps>> = {
  arrow: ArrowIcon,
  arrowUp: ArrowUpIcon,
...
export const Icon = ({ name, ...rest }: { name: IconName } & IconProps) => {
  const C = I[name];
